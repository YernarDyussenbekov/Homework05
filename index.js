...
// Заменяем содержимое элемента <body> на комментарий,
// включающий имя тега <body>
body.innerHTML = "<!--" + body.tagName + "-->";

// Выводим содержимое первого потомка элемента <body>,
// который является текстовым узлом с данными комментария
